...
while True:
	...
	for pt in zip(*locd[::-1]):
	    ...
	    if(D):
	     	subprocess.Popen([os.path.abspath('C:\Users\lenovo\Downloads\hackathon-20160731T091129Z\hackathon\Emajor.wav')])
	    	D=0
	    	E,A,G = 1,1,1
	...
	for pt in zip(*loca[::-1]):
	    ...
	    if(A):
	     	subprocess.Popen([os.path.abspath('C:\Users\lenovo\Downloads\hackathon-20160731T091129Z\hackathon\Amajor.wav'])
	        A=0
	    	E,D,G = 1,1,1 
	...
	for pt in zip(*locg[::-1]):
	    ...
	    if(G):
	     	subprocess.Popen([os.path.abspath('C:\Users\lenovo\Downloads\hackathon-20160731T091129Z\hackathon\Gmajor.wav'])
	    	G=0
	    	E,A,D = 1,1,1    	   	    	
